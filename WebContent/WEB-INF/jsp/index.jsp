...
<meta name="keywords" content="爱月商城  爱月城堡" />
<title>爱月商城</title>
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
						         <s:iterator var="plist" value="plist">
									<li>
										<a target="_blank" href="${pageContext.request.contextPath}/product_findOne.action?pid=<s:property value='#plist.pid'/>"><img src="${pageContext.request.contextPath}/<s:property value='#plist.image'/>?pid=<s:property value='#plist.pid'/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
									</s:iterator>
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 -->						
						 <ul class="tabContent" style="display: block;">
						         <s:iterator var="nlist" value="nlist">
						             <li>
										<a target="_blank" href="${pageContext.request.contextPath}/product_findOne.action?pid=<s:property value='#nlist.pid'/>"><img src="${pageContext.request.contextPath}/<s:property value='#nlist.image'/>" data-original="http://storage.shopxx.net/demo-image/3.0/201301/c5b1b396-181a-4805-9e68-9b400d71f91e-thumbnail.jpg" style="display: block;"></a>
									</li>
									</s:iterator>
