...
<div class="headerAd">
	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span6">
			<div class="hotProductCategory">
			          <s:iterator var="clist" value="#session.clist">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath}/product_findByPagecid.action?cid=<s:property value="#clist.cid"/>&page=1"><s:property value="#clist.cname"/></a>
							</dt><s:iterator var="cslist" value="#clist.categorySecond">
									<dd>
										<a href="${pageContext.request.contextPath}/product_findByPagecsid.action?csid=<s:property value="#cslist.csid"/>&page=1"><s:property value="#cslist.csname"/></a>
									</dd>	
									</s:iterator>								
						</dl>
						</s:iterator>
		...
		<div class="span18 last">
			...
			<form action="${pageContext.request.contextPath}/cart_addCart?pid=<s:property value="model.pid"/>&page=1" method="post" id="cartForm">
				<div class="action" >
