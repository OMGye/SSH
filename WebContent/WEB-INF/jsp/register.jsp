...
//获得文本框的值
  function checkUsername(){
   ...
   if(username == null || username == '' || username.length<3){
      document.getElementById('tip').innerHTML = "用户名不能小于三位";     
       return false;
    }
  ...
  function checkPassword() {
   ...
   if(password == null || password == '' || password.length<6){
      document.getElementById('tip_2').innerHTML = "密码不能小于6位";     
       return false;
    }
     document.getElementById('tip_2').innerHTML="";
        return true; 
  }
  function checkRepassword() {
   ...
   if(password != repassword){
      document.getElementById('tip_3').innerHTML = "两次密码输入不一致";     
       return false;
    }
     document.getElementById('tip_3').innerHTML="";
        return true; 
  }
  function change(){
    var checkImg = document.getElementById("checkImg");
    checkImg.src="${pageContext.request.contextPath}/checkImg.action?time="+new Date().getTime();
  }
</script>
</head>
<body>
					...
					<form id="registerForm"  method="post" novalidate="novalidate"  action="${pageContext.request.contextPath}/user_register.action">
						<table>
							...
							<tr>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off" onblur="return checkPassword()">
							...
							<tr>
								...
								<td>
									<input type="password" id="repassword" name="repassword" class="text" maxlength="20" autocomplete="off" onblur="return checkRepassword()">
