	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/adminCategory_toaddPage.action";
			}
		</script>
	</HEAD>
	<body>
									...
									<s:iterator var="c" value="cList" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminCategory_toeditPage.action?cid=<s:property value="#c.cid"/>&cname=<s:property value="#c.cname"/>">
