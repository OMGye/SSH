...
<div class="container cart">
		...
		<div class="span24">
						...
						<th colspan="5">订单编号<s:property value="#order.oid"/>&nbsp;&nbsp;&nbsp;&nbsp;
						 订单状态
						   <s:if test="#order.state == 1">
						         <a href="${pageContext.request.contextPath}/order_findByid?oid=<s:property value="#order.oid"/>"><font color="red">付款</font></a>
						   </s:if>
           ...
           <s:if test="pageBean.page!=1">
			<a class="firstPage" href="${pageContext.request.contextPath}/order_select.action?page=1">&nbsp;</a>			
			<a class="previousPage" href="${pageContext.request.contextPath}/order_select.action?page=<s:property value='pageBean.page-1'/>">&nbsp;</a>
			</s:if>	
			  <s:iterator var="i" begin="1" end="pageBean.totalPage">
			    <s:if test="pageBean.page != #i">
				<a href="${pageContext.request.contextPath}/order_select.action?page=<s:property value='#i'/>"><s:property value='#i'/></a>
				</s:if>
				<s:else>
			...
			<a class="nextPage" href="${pageContext.request.contextPath}/order_select.action?page=<s:property value='pageBean.page+1'/>">&nbsp;</a>			
			<a class="lastPage" href="${pageContext.request.contextPath}/order_select.action?page=<s:property value='pageBean.totalPage'/>">&nbsp;</a>
	      </s:if>
	     </div>
	     </td>
					</tr>
